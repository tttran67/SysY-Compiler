...
public:
    ...
    Instruction* begin() { return head->getNext();};//第一条指令
    Instruction* end() { return head;};//dummyinstruction
    Instruction* rbegin() { return head->getPrev();};//最后一条指令
    Instruction* rend() { return head;};//dummyinstruction
